...
![](/docs/images/Untitled-454a3b1a-2985-48fa-bee5-c6a992296378.png){: width="600" height="500"}
...
![](/docs/images/Untitled-819f0c90-24a8-4fb1-8ec3-ee152b59840a.png){: width="600" height="500"}
...
![](/docs/images/Untitled-177fc700-b8fd-41a7-ba54-f3ae5357ef09.png){: width="600" height="500"}

타사 데이터를 활용하기 위해서는 공유요청 및 승인을 통해 별도의 database 주소가 제공됩니다.

![](/docs/images/Untitled-2c18e559-8252-4436-a99d-64d2af70d5ff.png){: width="600" height="500"}
...
![](/docs/images/Untitled-e8551ced-e477-4ba4-9d11-08254e9812cb.png){: width="600" height="500"}

Notebook 환경설정을 위해 기본 셋팅 값 이외에 학습 환경을 설정합니다.

![](/docs/images/Untitled-99c2b7a7-69f9-45f6-b9b3-e936169a6218.png){: width="600" height="500"}

### Step3. Notebook 실행하기 (Jupyter Lab 환경 제공)
{: .fw-700 }

![](/docs/images/Untitled-777db72c-8e0c-445a-9431-2af8ae0c3423.png){: width="600" height="500"}
...
![](/docs/images/Untitled-e6fc8af9-8b38-4799-b74a-4197786af799.png){: width="600" height="500"}
...
![](/docs/images/Untitled-470e2536-487b-48d7-8183-53201df25143.png){: width="600" height="500"}
...
![](/docs/images/Untitled-1d823b21-c2d2-4477-8c11-96611555b953.png){: width="600" height="500"}
...
![](/docs/images/Untitled-3473b155-2eec-45ec-9b85-bf0d22ca37e8.png){: width="600" height="500"}
